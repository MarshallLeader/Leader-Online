            ...
            {TRUST_ITEMS.map((item, idx) => (
              ...
              >
                ...
                {idx !== TRUST_ITEMS.length - 1 && (
                  <div className="hidden lg:flex absolute -right-[1px] top-1/2 -translate-y-1/2 h-24 items-center justify-center">
                    <div className="w-[2px] h-full bg-primary/10 rounded-full" />
                    <div className="absolute w-2.5 h-2.5 bg-accent rotate-45 shadow-[0_0_10px_rgba(0,184,212,0.4)] group-hover:scale-150 transition-all duration-500" />
                  </div>
                )}
                ...
                <div className="w-10 h-1 bg-accent/10 mt-8 rounded-full group-hover:w-24 group-hover:bg-accent transition-all duration-700 ease-out" />
              </motion.div>
            ))}
          </div>
        </div>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 mb-12">
                ...
                <button 
                  onClick={() => setShowLearnMoreOverlay(true)}
                  className="bg-white/10 backdrop-blur-md text-white border border-white/20 px-8 py-4 rounded-full font-bold text-sm hover:bg-white hover:text-primary transition-all active:scale-95"
                >
                  Want to learn more?
                </button>
              </div>
                      ...
                      >
                        ...
                        <div className="p-8">
                          ...
                          <div className="flex gap-2 mb-6">
                            ...
                            <span className="text-[10px] font-bold bg-surface/50 border border-surface px-3 py-1 rounded-full text-muted flex items-center gap-1">
                              <Monitor className="w-3 h-3" /> {product.ram}
                            </span>
                          </div>
