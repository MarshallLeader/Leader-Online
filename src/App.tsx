...
const BREEZE_PARTICLE_CONFIG = Array.from({ length: 15 }, (_, i) => ({
  id: i,
  x: `${Math.random() * 100}%`,
  y: `${Math.random() * 100}%`,
...
const BreezeProductDetail = () => {
  return (
    <div className="min-h-screen bg-[#020617] text-white overflow-x-hidden relative">
      ...
      {/* Dynamic Background Graphics — absolute within component, dark cinematic feel */}
      <div className="absolute inset-0 z-0 pointer-events-none overflow-hidden">
        ...
        {BREEZE_PARTICLE_CONFIG.map((cfg) => (
          <motion.div
            key={cfg.id}
            initial={{ x: cfg.x, y: cfg.y, scale: cfg.scale, opacity: cfg.opacity }}
        ...
        <div className="max-w-7xl mx-auto w-full grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-7 relative flex justify-center order-1 lg:order-2 self-center">
            <div className="relative w-full max-w-[700px] group">
              ...
              <div className="relative aspect-[16/10] bg-white/[0.03] backdrop-blur-xl border border-white/10 rounded-2xl overflow-hidden shadow-2xl">
            ...
            <div className="lg:col-span-4 space-y-12">
              ...
              <div className="space-y-6">
                {[
                  ...
                  <div key={feat.title} className="flex items-center gap-6 group cursor-default">
